...
This file contains the help texts for each of the interactive elements 
in the user interface. The help texts are displayed when the user hovers 
the cursor over the corresponding elements, providing additional information 
about their function or usage.
...
HELP_OBSERVACIÓN3= (
    "** Cuando el usuario registre parcelas sin volumen, estas deberán ser analizadas por cada profesional para\nsu inclusión en áreas degradadas."
)